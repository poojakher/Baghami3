...
function card_gen_loopLoopBegin(card_gen_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  card_gen_loop.forEach(function() {
...
function instr_learningRoutineBegin(snapshot) {
  return function () {
    ...
    instr_learningComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function card_genRoutineBegin(snapshot) {
  return function () {
    ...
    card_genComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function initialize_trialRoutineBegin(snapshot) {
  return function () {
    ...
    initialize_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function interpret_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    interpret_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function pick_deckRoutineBegin(snapshot) {
  return function () {
    ...
    pick_deckComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function interpret_pickRoutineBegin(snapshot) {
  return function () {
    ...
    interpret_pickComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function init_active_cardsRoutineBegin(snapshot) {
  return function () {
    ...
    init_active_cardsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instr_studyRoutineBegin(snapshot) {
  return function () {
    ...
    instr_studyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function studyingRoutineBegin(snapshot) {
  return function () {
    ...
    studyingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instr_testRoutineBegin(snapshot) {
  return function () {
    ...
    instr_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function show_answer_promptRoutineBegin(snapshot) {
  return function () {
    ...
    show_answer_promptComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function show_answerRoutineBegin(snapshot) {
  return function () {
    ...
    show_answerComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function change_methodRoutineBegin(snapshot) {
  return function () {
    ...
    change_methodComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instr_movieRoutineBegin(snapshot) {
  return function () {
    ...
    instr_movieComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instr_assessRoutineBegin(snapshot) {
  return function () {
    ...
    instr_assessComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function assessRoutineBegin(snapshot) {
  return function () {
    ...
    assessComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ans_genRoutineBegin(snapshot) {
  return function () {
    ...
    ans_genComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instr_transferRoutineBegin(snapshot) {
  return function () {
    ...
    instr_transferComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function transferRoutineBegin(snapshot) {
  return function () {
    ...
    transferComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
